...
namespace ExperienceExtractor.Components.Parsing.JobLoaders
{
    [ParseFactory("direct", "Default job factory", "Parses a JSON job specification")]
    public class DirectJobLoaderFactory : IParseFactory<IJobLoader>
    {
